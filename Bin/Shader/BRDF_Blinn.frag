...
layout (location = 3) in vec3 inDirectionLightDirection;
...
void main()
{
	...
	vec3 envDiffuseColor = Diffuse_SH(albedoColor, 0.0, pixelNormalWorld, engineAmbientLight.rotationMatrix, engineAmbientLight.shRed0, engineAmbientLight.shRed1, engineAmbientLight.shRed2, engineAmbientLight.shGreen0, engineAmbientLight.shGreen1, engineAmbientLight.shGreen2, engineAmbientLight.shBlue0, engineAmbientLight.shBlue1, engineAmbientLight.shBlue2);
//	vec3 lightColor = BRDF_Blinn(engineDirectionLight.color, inDirectionLightDirection, inHalfDirection, pixelNormal, albedoColor, specularColor.rgb, roughness);
	vec3 lightColor = BRDF_BlinnGGX(engineDirectionLight.color, inDirectionLightDirection, inHalfDirection, inViewDirection, pixelNormal, albedoColor, specularColor.rgb, roughness);
