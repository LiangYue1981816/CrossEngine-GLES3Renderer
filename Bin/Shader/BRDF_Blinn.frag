...
void main()
{
	...
	vec3 lightColor = BlinnDirectionLighting(mainDirectionLightColor, mainDirectionLightDirection, inHalfDirection, inViewDirection, pixelNormal, albedoColor, specularColor, metallic, roughness);
