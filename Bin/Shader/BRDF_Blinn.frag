...
void main()
{
	...
	vec3 lightColor = BlinnLighting(mainDirectionLightColor, mainDirectionLightDirection, inHalfDirection, inViewDirection, pixelNormal, albedoColor, specularColor, metallic, roughness);
