...
void main()
{
	...
	vec3 envAmbientColor = Ambient_SH9(albedoColor, 0.0, pixelNormal, engineAmbientLight.rotationMatrix, engineAmbientLight.shRed0, engineAmbientLight.shRed1, engineAmbientLight.shRed2, engineAmbientLight.shGreen0, engineAmbientLight.shGreen1, engineAmbientLight.shGreen2, engineAmbientLight.shBlue0, engineAmbientLight.shBlue1, engineAmbientLight.shBlue2);
