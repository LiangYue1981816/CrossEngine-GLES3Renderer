...
void main()
{
	...
	vec3 lightColor = PBRDirectionLighting(mainDirectionLightColor, mainDirectionLightDirection, inHalfDirection, inViewDirection, pixelNormal, albedoColor, metallic, roughness);
